...
function preload(){
    computer_image = loadImage("https://m.economictimes.com/thumb/msid-75719903,width-1200,height-900,resizemode-4,imgsize-290552/8.jpg");
}
...
function draw(){
    image(computer_image,0,0,640,350);
    if(Status != ""){
